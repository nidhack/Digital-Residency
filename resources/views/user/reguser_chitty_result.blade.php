   ...
   ?>
		...
		<div class="message warning">
			<div class="inset agile">
				...
				<input  type="hidden" class="form-control" disabled name="chitty_id" value="<?php echo $row->chitty_id;?>"/><br>
				...
				<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
					<ul class="resp-tabs-list">
						...
						<h3> <font color="#ff8080">Others Please Wait For Next Turn </font></h3>
