...
<?php
  ...
  $id=Auth::user()->id;
$st=DB::select("SELECT tbl_chitty_join.chitty_id,tbl_chitty_details.chitty_det_amount,tbl_chitty_details.chitty_name  FROM tbl_chitty_join,tbl_chitty_details  where tbl_chitty_join.id='$id' and tbl_chitty_details.chitty_id=tbl_chitty_join.chitty_id ORDER BY id DESC Limit 3 ");
foreach($st as $row)
{
 		...
 		<div class="message warning"  style="float:left;width:500px;">
			<div class="inset agile">
				<div class="sap_tabs w3ls-tabs" style="width:300px;">
                        ...
                        <form action="/chittypayment?id={{$row->chitty_id}}" method="post">
                        <input type="hidden" name="_token" value="{{@csrf_token()}}"/>
												@csrf
												<input  type="text" class="form-control" disabled id="chitty_name" name="chitty_name" value="<?php echo $row->chitty_name?>"/><br>
