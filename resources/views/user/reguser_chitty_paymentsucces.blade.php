...
<!-- #Header Starts -->
     ...
     <h1>CHITTY PAYMENT SUCCESFUL</h1>
...
<body>
<?php
//  $st=DB::select("SELECT * FROM tbl_chitty_result ORDER BY c_result_id DESC Limit 1");
//  $st=DB::select("SELECT * FROM tbl_reg_user,tbl_chitty_result where tbl_chitty_result.id=tbl_reg_user.id");
//  foreach($st as $row)
