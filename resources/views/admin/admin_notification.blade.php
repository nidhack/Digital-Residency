    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          ...
          <form action="/notiadd" method="post" name="user_chittyjoin" enctype="multipart/form-data">
  @csrf
  <label><font color="#DFD8D8">Notifiaction Category</font></label>
  <select name="NotificationCategory"   class="form-control" >

<option >sellect</option>
  <option value="House Members">House Members</option>
  <option value="Chitty Members">Chitty Members</option>


  
</select>
  
<label><font color="#DFD8D8">Notification</font></label> <input type="text" name="noti" class="form-control">

     <input type="hidden" name="chitty_id" class="form-control">
      <input  type="hidden"  name="date" class="form-control" value="{{$date}}">

               
              <input type="hidden" name="chitty_id" class="form-control" value="0">
