...
<li class="sub-menu">
    ...
    <div class="product-block">
    	<div class="pro-head">
    		...
    		<h2>Complaint And Response</h2>
    	</div>
    	
          <?php 
          $st=DB::select("select * from tbl_complaint,tbl_reg_user where tbl_reg_user.id=tbl_complaint.id");
          foreach($st as $row)
            {
               ...
               <div class="work-progres">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
             					...
             					<tr>
									<th>Complaint_id</th><th>User Name</th><th>Complaint</th><th>House Number</th><th>Response</th><th>Send Response</th></tr>
					        
						  

						<tr> <td><input type="text" class="form-control" value="<?php echo $row->complaint_id;?>" name="c_id" disabled></td>
               
                <td><input type="text" class="form-control" placeholder="Email Address" value="<?php echo $row->u_reg_fname;?>" name="u_email" disabled></td>
               <td> <input type="text" class="form-control" placeholder="Contact Number" value="<?php echo $row->complaint_complaint;?>" name="u_complaint" disabled></td>
               <td> <input type="text" class="form-control" placeholder="Contact Number" value="<?php echo $row->u_reg_hno;?>" name="u_complaint" disabled></td>

               <td> 
               <form action="/complaintupdate?id={{$row->complaint_id}}" method="post" name="admin_notification">
               <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <textarea rows="6" class="form-control" placeholder="Message" name="c_response"></textarea></td>
               <td> <input type="hidden" value="" name="c_id">
