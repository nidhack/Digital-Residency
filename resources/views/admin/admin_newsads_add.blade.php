...
<form  method="post"  action="/adnewsadmin" enctype="multipart/form-data">
<input type="hidden" name="_token" value="{{ csrf_token() }}">


<label><font color="#005893">Upload  Image</font></label>
<input  name="uploadedimage" class="form-control" type="file" placeholder="Photo">
<label><font color=" #005893">Select the Type</font></label>
<select name="newsAds_status"   class="form-control" placeholder="Photo">
