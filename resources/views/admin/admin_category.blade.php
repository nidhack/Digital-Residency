...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo">BABYCARE<span class="lite">ADMIN</span></a>
      <!--logo end-->
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <li><a class="" href="/admin.rusers">View Users</a></li>
              ...
              <li><a class="" href="/viewcategoryy">View Brands</a></li>
            </ul>
          </li>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-files-o"></i><b>ADD CATEGORY</b></h3>
            <ol class="breadcrumb">
          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form">
                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="/saveCategory">
                  @csrf
  ...
  <!-- javascripts -->
  <script src="merchant/js/jquery.js"></script>
  <script src="merchant/js/bootstrap.min.js"></script>
  <!-- nice scroll -->
  <script src="merchant/js/jquery.scrollTo.min.js"></script>
  <script src="merchant/js/jquery.nicescroll.js" type="text/javascript"></script>
  <!-- jquery validate js -->
  <script type="merchant/text/javascript" src="js/jquery.validate.min.js"></script>

  <!-- custom form validation script for this page-->
  <script src="merchant/js/form-validation-script.js"></script>
  <!--custome script for all page-->
  <script src="merchant/js/scripts.js"></script>
