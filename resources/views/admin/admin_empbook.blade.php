        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li><a class="" href="/notiview">VIEW</a></li>
         ...
         <li class="sub-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="" href="/adminbookviewemp"> VIEW MEMBERS</a></li>
              </ul>
...
<li class="sub-menu">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <?php 
            $id = Auth::user()->id;
          $st=DB::select("select * from tbl_empbooking,tbl_emp_reg where  tbl_empbooking.empname=tbl_emp_reg.id ");
          ;
