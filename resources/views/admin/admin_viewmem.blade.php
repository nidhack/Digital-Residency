...
<li class="sub-menu">
	...
	<div class="bg-layer" >
		<h2><font color=" #ff0080"> <center>House Members Details
       </font> </h2>
		<div class="header-main" style="width:450px;"> 
			...
			<?php
//
 $st=DB::select("select * from tbl_housemembers_datails where 	home_mem_houseno='$housno'");

 foreach($st as $row)
   {
 //echo $email;
// echo $row->id;
  // echo $row->home_mem_houseno;
?>

<div class="message warning"  style="float:left;width:500px;">
			<div class="inset agile">
				<div class="sap_tabs w3ls-tabs" style="width:300px;height:700px;">
			
					<form method="post" action="#" enctype="multipart/form-data">
	  @csrf
    
					<img src="housemembers/<?php echo $row->home_mem_image; ?>" alt=""  height="150px" width="150px">
					
        <div class="text-center">
        <input type="hidden" class="" disabled name="photo">
      </div></hr><br>
<div class="form-group">

<label><font color=" #ff0080">First name</font></label>
				            <input  type="text" class="form-control"  name="first_name" id="first_name" placeholder="first name"  disabled  value="<?php echo $row->home_mem_name; ?>"/><br>
																 
<label><font color=" #ff0080">Occupation</font></label>
                            <input  type="text" class="form-control"name="last_name" id="last_name" placeholder="last name" disabled value="<?php echo $row->home_mem_occupation; ?>"/><br>
              
	<label><font color=" #ff0080">Date Of Birth</font></label>
                            <input  type="text" class="form-control"name="last_name" id="last_name" placeholder="last name"  disabled value="<?php echo $row->home_mem_d_o_b; ?>"/></><br>
