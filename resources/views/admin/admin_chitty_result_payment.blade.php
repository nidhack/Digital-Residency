    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          ...
          <!--/.col-->
          <form action="/adminaddchitty" method="Get" name="admin_adnews" name="admin_chitty_add">
              @csrf
              <input type="text" class="form-control" placeholder="Amount of chitty" name="amount">
              <input type="text" class="form-control" placeholder="Details of chitty" name="details">
                <input type="text" class="form-control" placeholder="chitty total number of payments" name="payment">
              
               
                <input type="date" class="form-control" placeholder="Chitty Joining Last date" name="date">
        <input type="date" class="form-control" placeholder="Chitty closing Last date" name="expdate">
       
       
                 <input type="submit" class="btn btn-success" name="Submit">Add</button>
