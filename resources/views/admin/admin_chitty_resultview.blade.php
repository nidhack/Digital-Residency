...
<li class="sub-menu">
 ...
 $st=DB::select("SELECT * FROM tbl_reg_user,tbl_chitty_result where tbl_chitty_result.id=tbl_reg_user.id  ORDER BY c_result_id DESC Limit 3");
 foreach($st as $row)
   ...
   ?>
		...
		<div class="message warning">
			<div class="inset agile">
							...
							<h2>
								<label>CONGRATULATIONS</label></h2>
								
                                <form action="/adminchittycashtransfer?id={{$row->id}}&&cid={{$row->chitty_id}}" method="post">
                                <input type="hidden" name="_token" value="{{@csrf_token()}}"/>
                                @csrf
                   
  <input type="hidden" class="form-control" name="id" value="<?php echo $row->id;?>">   
								<label><font color=" #ff0080">Chitty Id</font></label>
				<input  type="text" class="form-control" disabled name="chitty_id" value="<?php echo $row->chitty_id;?>"/><br>
			
									
									
								<label><font color=" #ff0080">Name of Chitty Winner</font></label>
				<input  type="text" class="form-control" disabled name="chitty_id" value="<?php echo $row->u_reg_fname;?>"/><br>
			
				<label><font color=" #ff0080">House Number</font></label>
				<input  type="text" class="form-control" disabled name="chitty_id" value="<?php echo $row->	u_reg_hno;?>"/><br>
                ...
                <div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
                            <ul class="resp-tabs-list">
						        ...
						        <input type="submit" class="btn btn-success" name="submit" value="Cash Transfer">
