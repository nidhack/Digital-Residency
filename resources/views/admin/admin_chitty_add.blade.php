    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <!--/.row-->
          ...
          <div class="col-md-3">
            <!-- List starts --><!--/.info-box-->
          </div>
          <!--/.col-->
          <form action="/adminaddchitty" method="Get" name="admin_adnews"   name="admin_chitty_add" onsubmit="return">
              @csrf
              <label><font color=" #005893">Name of chitty</font></label>
              <input type="text" class="form-control cv-positive" placeholder="Name of chitty" name="name" >
           
              <label><font color=" #005893">Amount of chitty</font></label>
              <input type="text" class="form-control cv-positive" placeholder="Amount of chitty" name="amount" pattern="[0-9]*">
              <label><font color=" #005893">Details of chitty</font></label>
              <input type="text" class="form-control" placeholder="Details of chitty" name="details">
              <label><font color=" #005893">chitty total number of payments</font></label>
                <input type="text" class="form-control  " placeholder="chitty total number of payments" name="payment" pattern="[0-9]{2}">
                <label><font color=" #005893">Chitty Joining  date</font></label>
               
                <input type="date" class="form-control" placeholder="Chitty Joining  date" name="date" min="2019-05-03" >
                <label><font color=" #005893">Chitty closing Last date</font></label>
                <input type="date" class="form-control" placeholder="Chitty closing Last date" name="expdate" min="2019-05-03">
