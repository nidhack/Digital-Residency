    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          ...
          <form action="/notificationadd" method="Get" name="admin_adnews" name="admin_chitty_add">
              @csrf
            
               <textarea rows="6" class="form-control" placeholder="Notification" name="noti"></textarea>
