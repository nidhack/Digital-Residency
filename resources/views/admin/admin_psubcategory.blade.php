         ...
         <li class="sub-menu">
           <a href="#" class="">
            ...
            <ul class="sub">
              ...
              <li><a class="" href="#"> Chitty Pay</a></li>
        ...
        <div class="row">
          ...
          <header class="panel-heading">
              ...
              <div class="panel-body">
                <div class="form">
                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="/saveSubcategoryy">
                  @csrf
                  <div class="form-group ">
                      <label for="agegroup" class="control-label col-lg-2"><b>Select Category </b> <span class="required"></span></label>
                      <div class="col-lg-10">
				            	<select class="form-control" name="category" style="width:280px;" id="category_id" required="">
					               <option>---Select---</option>
                                   @isset($data)
                                   {{$data}}
                                   @foreach($data as $datas)
                                   <option value="{{$datas->category_id}}">{{$datas->tbl_category}}</option>
                                   @endforeach
                                   @endisset
                                   </select>
			                     </div>
                    ...
                    <div class="form-group ">
                      <label for="category" class="control-label col-lg-2"><b>Sub Category </b><span class="required"></span></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="pcategory" name="pcategory" style="width:280px;" minlength="2" type="text" required />
                      </div>
                    </div>
