    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          ...
          <form action="/notiadds" method="post" name="user_chittyjoin" enctype="multipart/form-data">
  @csrf
  


  <input type="hidden" name="NotificationCategory" class="form-control" value="Chitty Members">

  
<label><font color="#DFD8D8">Notification</font></label> <input type="hidden" name="noti" class="form-control" value="Please Pay Your Last Installment ">

 <input type="hidden" name="date" value="{{$date}}" class="form-control">

               
    <input type="hidden" name="chitty_id" class="form-control" value="<?php echo $chittyid;?>">
