        ...
        <div class="row">
          ...
          <header class="panel-heading">
              ...
              <div class="panel-body">
                ...
                <?php 
                 $st=DB::select("select u_reg_hno from tbl_reg_user");
               
?>
                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="/viewmem">
                  @csrf
                  
					<select class="form-control" name="category" style="width:280px;" id="category_id" required="">
                                   <option>---Select---</option>
                                   @foreach($st as $t)
                               <option value="{{$t->u_reg_hno}}">{{$t->u_reg_hno}}</option>
                   @endforeach
                    <div class="form-action">
                      <div class="col-lg-offset-2 col-lg-10">
                        <input type="submit" value="View Members" class="btn btn-primary"></button>
