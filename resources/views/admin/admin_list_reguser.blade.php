    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          ...
          <!--/.col-->
          <table border="2" id="table1" data-toggle="table" data-pagination="true" data-show-columns="true" data-cookie="true" data-page-size="10" data-page-list="[10, 20, 30, 40, 50]" data-cookie-id-table="saveId">
                                            <thead>
                                                <tr>    `   
                                                    <th data-field="status" data-editable="true">Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </th>
                                                    <th data-field="status" data-editable="true">Occupation&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </th>
                                                  
                                                    <th data-field="phone" data-editable="true">Email Id&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                                                    <th data-field="company" data-editable="true">Phone&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                                                    <th data-field="company" data-editable="true">House Number&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                                                    <th data-field="company" data-editable="true">Status&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                                                    <th data-field="company" data-editable="true">Approve/Reject&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                                                    <th data-field="company" data-editable="true">Delete&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                ...
                                                @foreach($st as $approve)
                                                    <td>{{$approve->u_reg_fname}}</td><td>{{$approve->u_reg_job}}</td>
                                                     <td>{{$approve->email}}</td>
                                               ...
                                               <td>{{$approve->u_reg_phone}}</td>
                                                  <td>{{$approve->u_reg_hno}}</td>                                               
                                                                  ...
                                                                  <td><a href="{{url('Approveru/'.$approve->id)}}">Delete</a></td>
