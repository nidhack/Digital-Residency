          ...
          <table id="table1" data-toggle="table" border="2">
                                            <thead>
                                                <tr>    `   
                                                    ...
                                                    <th data-field="email" data-editable="true">&nbsp;&nbsp;Job&nbsp;&nbsp;</th>
                                                    ...
                                                    <th data-field="company" data-editable="true">&nbsp;&nbsp;Approve&nbsp;&nbsp;</th>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($sd as $approve)
                                                    <td>{{$approve->emp_reg_fname}}</td>
                                                    <td>{{$approve->emp_reg_job}}</td>
                                                     <td>{{$approve->email}}</td>
                                               ...
                                               <td>{{$approve->emp_reg_phone}}</td>
                                                                  ...
                                                                  <td><a href="{{url('Approvee/'.$approve->id)}}">Change Status</a></td>
                                                                  <td><a href="{{url('Approveemp/'.$approve->id)}}">Delete</a></td>
