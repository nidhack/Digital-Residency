    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          ...
          $st=DB::select("select * from tbl_reg_user,tbl_chitty_join where tbl_reg_user.id=tbl_chitty_join.id and chitty_id='$c' ");
          foreach($st as $row)
            {
          ?>
              <?php
          ...
          <table id="table1" data-toggle="table" border="2">
                                            <thead>
                                                <tr>    `   
                                                  <th data-field="company" data-editable="true">&nbsp;&nbsp;Id&nbsp;&nbsp;</th>
                                                    <th data-field="status" data-editable="true">&nbsp;&nbsp;Name&nbsp;&nbsp;</th>
                                  
                                                    <th data-field="phone" data-editable="true">&nbsp;&nbsp;Chitty Id &nbsp;&nbsp;</th>
                                                    <th data-field="company" data-editable="true">&nbsp;&nbsp;Phone&nbsp;&nbsp;</th>
                                                
                                                    <th data-field="company" data-editable="true">&nbsp;&nbsp;&nbsp;House No&nbsp;</th>
                                                    <th data-field="company" data-editable="true">&nbsp;&nbsp;Paid Status&nbsp;&nbsp;</th>
                                                    <th data-field="company" data-editable="true">&nbsp;&nbsp;Result Status&nbsp;&nbsp;</th>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($st as $approve)
                                                    <td>{{$approve->id}}</td>
                                                    <td>{{$approve->u_reg_fname}}</td>
                                                    <td>{{$approve->chitty_id}}</td>
                                                   
                                                   
                                           
                                               <td>{{$approve->u_reg_phone}}</td>
                                               <td>{{$approve->u_reg_hno}}</td>
                                               <td>{{$approve->chitty_paid_status}}</td>
                                               <td>{{$approve->chitty_result_status}}</td>
                                        ...
                                        <form action="/lot?id="  name="lot" enctype="multipart/form-data"> 
        </div> <a href="/lot?id={{$approve->chitty_id}}"><input type="button" class="btn btn-success" name="Submit" value="LOT"></button></a>
